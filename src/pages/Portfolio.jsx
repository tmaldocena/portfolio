  ...
  if(!isMobile){
    return (
      <div className="grid grid-cols-4 grid-rows-3 content-center px-8 gap-6 h-[85vh]">
        <CardTall classes="row-span-2  rounded-2xl text-black bg-[url('./cyberspeed.png')] border-second" project={priority[2]} lang={lang} ></CardTall>

        <CardTall classes="row-span-2 col-start-4 row-start-2 bg-white rounded-2xl text-white bg-[url('./nike.png')] border-main" project={priority[1]} lang={lang} ></CardTall>
